...
def parse_args():
    ...
    # Data path
    parser.add_argument(
        "--video_list_file", default="data/Howto-Interlink7M_subset_w_all_clips_val.txt",type=str, help="path to howto100m_videos.txt"
    )
    parser.add_argument(
        "--save_dir",
        default="videos/Howto-Interlink7M_subset_w_all_clips_val",
        type=str,
